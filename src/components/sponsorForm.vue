        ...
        <div class="flex flex-col gap-6 w-full">
          ...
          <div class="flex gap-6 w-full flex-col">
            <div class="flex items-center h-[64px] gap-5">
              ...
              <span class="font-medium">Amonov Ilhom Aliyevich</span>
            </div>
      ...
      <form
        ...
        <div class="flex items-center h-[40px] w-full">
          <div class="flex items-center w-full border rounded-md border-[#E0E7FF] justify-between h-full">
            ...
            <button class="uppercase flex items-center justify-center h-full cursor-pointer rounded-br-md rounded-tr-md hover:bg-blue-400 hover:text-white w-full font-500"
        ...
        <div class="flex flex-col w-full h-[64px] gap-2">
          <span class="uppercase text-sm h-[14px] flex font-medium">F.i.sh (Familiya ism sharifingiz)</span>
          <input type="text"
